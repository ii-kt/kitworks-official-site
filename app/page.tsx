...
import { careerRecord } from "./career-data";
  ...
  if (panel === "portfolio") {
    return (
      <div className="panel-view business-view portfolio-view">
        <PanelKicker en="PORTFOLIO / PUBLISHED RECORD" ja="実績記録" />
        <section className="portfolio-hero">
          <div className="portfolio-hero__copy">
            <p className="editorial-eyebrow" lang="en">AI / PM / ENGINEERING</p>
            <h1 id="panel-title">AI × PM × ENGINEERING<br /><em>構想を、現場で動く<wbr />プロダクトへ。</em></h1>
            <p className="panel-lead">RAG型仕様書チャットボットの設計・構築、参照範囲制御、生成AI出力の評価設計、5名チームのAI案件PM、Jiraを用いた進行管理、成果物監査を経験。PoCから業務適用までの推進を担当。</p>
          </div>
          <PortfolioLedger />
        </section>
        ...
        <section className="portfolio-record-section portfolio-practice-section" aria-labelledby="portfolio-practice-title">
          <PortfolioSectionHeader number="01" en="PRACTICE" ja="実践領域" id="portfolio-practice-title" copy="AI活用、品質管理、開発を横断して担当してきた実務領域を整理。" />
        ...
        <section className="portfolio-record-section portfolio-cases-section" aria-labelledby="portfolio-cases-title">
          <PortfolioSectionHeader number="02" en="SELECTED CASES" ja="代表実績" id="portfolio-cases-title" copy="代表案件を、課題、役割、制約、判断、進め方、成果で整理。" />
        ...
        <section className="portfolio-record-section portfolio-scope-section" aria-labelledby="portfolio-scope-title">
          <PortfolioSectionHeader number="03" en="OPERATING SCOPE" ja="実務範囲" id="portfolio-scope-title" copy="AI/RAGの設計・評価、AI案件PM、成果物品質管理を含む実務範囲。" />
          <div className="portfolio-scope-grid">
            ...
            <div className="portfolio-pmo-scope">
              ...
              <h3>AI案件推進 /<br />品質管理</h3>
              <p>進捗・課題、成果物、レビュー観点、トレーサビリティ、会議体、AI出力の最終確認を対象に管理・確認。</p>
        ...
        <section className="portfolio-record-section portfolio-skills-section" aria-labelledby="portfolio-skills-title">
          <PortfolioSectionHeader number="05" en="SKILL INDEX" ja="技術・ツール" id="portfolio-skills-title" copy="実務で使用した技術・ツールを領域別に整理。" />
    ...
    return (
      <div className="panel-view business-view portfolio-view">
        ...
        <section className="portfolio-record-section portfolio-practice-section" aria-labelledby="career-summary-title">
          <PortfolioSectionHeader number="01" en="PROFESSIONAL SUMMARY" ja="職務要約・経験領域" id="career-summary-title" copy="開発、PM・PL、品質管理、AIに関する主な職務経験を整理。" />
          <div className="portfolio-principles">
        ...
        <section className="portfolio-record-section portfolio-history-section" aria-labelledby="career-employment-title">
          <PortfolioSectionHeader number="02" en="EMPLOYMENT" ja="所属経歴" id="career-employment-title" copy="所属会社と独立後の事業形態を案件履歴と分離して記載。" />
          <ol className="portfolio-timeline">
        ...
        <section className="portfolio-record-section portfolio-cases-section" aria-labelledby="career-experience-title">
          <PortfolioSectionHeader number="03" en="PROFESSIONAL EXPERIENCE" ja="職務経歴" id="career-experience-title" copy="2019年の研修から現在のAIプロジェクトまで、案件・研修を時系列で記載。" />
          <div className="portfolio-case-ledger">
        ...
        <section className="portfolio-record-section portfolio-skills-section" aria-labelledby="career-skills-title">
          <PortfolioSectionHeader number="04" en="SKILL INDEX" ja="技術・ツール" id="career-skills-title" copy="職務経歴書とスキルシートの技術・ツールを領域別に統合。" />
          <div className="portfolio-skill-index">
        ...
        <section className="portfolio-record-section portfolio-scope-section" aria-labelledby="career-activities-title">
          <PortfolioSectionHeader number="05" en="ACTIVITIES" ja="補足実績・資格・語学" id="career-activities-title" copy="案件履歴以外のAI活用実績、登壇、資格、語学を記載。" />
          <div className="portfolio-scope-grid">
            <div className="portfolio-ai-scope">
              <div className="portfolio-support-ledger">
        ...
        <section className="portfolio-record-section portfolio-history-section" aria-labelledby="career-selfpr-title">
          <PortfolioSectionHeader number="06" en="SELF STATEMENT" ja="自己PR" id="career-selfpr-title" copy="職務経歴書・スキルシート記載内容を現在の職務状況に合わせて整理。" />
          <div className="portfolio-pmo-scope">
...
function PortfolioSectionHeader({ number, en, ja, id, copy }: { number: string; en: string; ja: string; id: string; copy: string }) {
  return (
    <header className="portfolio-section-header">
      <span>{number}</span>
      <div><small lang="en">{en}</small><h2 id={id}>{ja}</h2></div>
      <p>{copy}</p>
    </header>
  );
}
